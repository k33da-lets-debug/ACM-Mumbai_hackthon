...
from .views import dummyView,loginView,dashboardView,logout_request,profileView,forgotpasswordView,reimbursementView,leaveView,meetingView,approveMeetingView,approveMeetingUpdate,approveLeaveView,approveLeaveUpdate,approveReimbursementView,approveReimbursementUpdate,applySalaryView
...
urlpatterns = [
    ...
    path('dummyView',dummyView,name='dummyView')
